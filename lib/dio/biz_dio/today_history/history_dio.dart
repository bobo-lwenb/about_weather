...
import 'package:about_weather/today_history/model/today_history.dart';
...
class HistoryDio extends BaseDio {
  ...
  Future getDayHistory(DateTime dateTime) async {
    Map<String, dynamic> params = {"day": dateTime.day, "month": dateTime.month};
    Map<String, dynamic> data = await get(path: TODAY_HISTORY_PATH, queryParams: params);
